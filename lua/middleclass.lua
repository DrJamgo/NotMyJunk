...
-- augment existing table wiht inheritance from theClass
-- call with: <MyClass>:augment(myTable, <init params>)
Object.augment = function(theClass, instance, ...)
  assert(_classes[theClass]~=nil, "Use class:new instead of class.new")

  instance.class = theClass
  local instance = setmetatable(instance, theClass.__classDict)
  instance:initialize(...)
  return instance
end
